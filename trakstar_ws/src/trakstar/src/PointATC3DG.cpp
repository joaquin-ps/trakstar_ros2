...
int PointATC3DG::check_bird_errors( void )
{
    ...
    switch( datain[0] ) {
        case 1:     printf("FATAL(1): System Ram Failure" ); fatal = true; break;
        case 2:     printf("FATAL(2): Non-Volatile Storage Write Failure" ); fatal = true; break;
        case 3:     printf("WARNING(3): PCB Configuration Data Corrupt" ); break;
        case 4:     printf("WARNING(4): Bird Transmitter Calibration Data Corrupt or Not Connected" ); break;
        case 5:     printf("WARNING(5): Bird Sensor Calibration Data Corrupt or Not Connected" ); break;
        case 6:     printf("WARNING(6): Invalid RS232 Command" ); break;
        case 7:     printf("WARNING(7): Not an FBB Master" ); break;
        case 8:     printf("WARNING(8): No Birds Accessible in Device List" ); break;
        case 9:     printf("WARNING(9): Bird is Not Initialized" ); break;
        case 10:    printf("WARNING(10): FBB Serial Port Receive Error - Intra Bird Bus" ); break;
        case 11:    printf("WARNING(11): RS232 Serial Port Receive Error" ); break;
        case 12:    printf("WARNING(12): FBB Serial Port Receive Error" ); break;
        case 13:    printf("WARNING(13): No FBB Command Response" ); break;
        case 14:    printf("WARNING(14): Invalid FBB Host Command" ); break;
        case 15:    printf("FATAL(15): FBB Run Time Error" ); fatal = true; break;
        case 16:    printf("FATAL(16): Invalid CPU Speed" ); fatal = true; break;
        case 17:    printf("WARNING(17): No FBB Data" ); break;
        case 18:    printf("WARNING(18): Illegal Baud Rate" ); break;
        case 19:    printf("WARNING(19): Slave Acknowledge Error" ); break;
        case 20: case 21: case 22: case 23:
        case 24: case 25: case 26: case 27:
            	    printf("FATAL(%d): Intel 80186 CPU Errors", datain[0] ); fatal = true; break;
        case 28:    printf("WARNING(28): CRT Synchronization" ); break;
        case 29:    printf("WARNING(29): Transmitter Not Accessible" ); break;
        case 30:    printf("WARNING(30): Extended Range Transmitter Not Attached" ); break;
        case 32:    printf("WARNING(32): Sensor Saturated" ); break;
        case 33:    printf("WARNING(33): Slave Configuration" ); break;
        case 34:    printf("WARNING(34): Watch Dog Timer" ); break;
        case 35:    printf("WARNING(35): Over Temperature" ); break;
        default:    printf("WARNING(%d): Unknown Error Code", datain[0] );
    }
